...
- `docs/spec/spec_v1/00_MASTER_SPEC.md` — master engineering spec (self-contained, implementation-ready)
- `docs/spec/spec_v1/10_API_CONTRACTS.md` — API contract details
- `docs/spec/spec_v1/20_RUNTIME_PROVIDER_INTERFACE.md` — runtime provider abstraction
- `docs/spec/spec_v1/30_DATA_MODEL_SUPABASE.md` — Supabase/PostgreSQL data model
- `docs/spec/spec_v1/40_SECURITY_SECRETS_COMPLIANCE.md` — security requirements
- `docs/spec/spec_v1/50_OBSERVABILITY_BILLING_LIMITS.md` — billing and limits
- `docs/spec/spec_v1/60_TESTING_ACCEPTANCE.md` — test plan
- `docs/spec/spec_v1/70_AMPERSAND_PROTOCOL_INTEGRATION.md` — [&] Protocol integration (capability manifests, MCP sidecars, A2A routing, governance)
